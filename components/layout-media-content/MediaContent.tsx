            ...
            <Container>
                <div className={`l-grid l-grid--align-items_center l-grid--vertical-gap ${gridClasses}`}>
                    <div className="l-grid__cell l-grid__cell--50-at-lg">
                        <RevealImage className="media-content__image" image={image} imageAlt={imageAlt} />
                    </div>

                    <div className="l-grid__cell l-grid__cell--50-at-lg">
                        <div className="media-content__copy">
                            {title && <RevealText as="h2" className="reveal-text--spacing_sm media-content__title" content={title}></RevealText>}
                            {content && (
                                <RevealText
                                    as="p"
