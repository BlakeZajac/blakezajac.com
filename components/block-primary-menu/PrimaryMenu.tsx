...
const MenuItem: React.FC<MenuItemProps> = ({ label, href }) => {
    ...
    return (
        <li className="primary-menu__item">
            <a href={href} className={`primary-menu__link ${isActive ? "primary-menu__link--active" : ""}`} itemProp="url">
...
const PrimaryMenu = () => {
    return (
        <nav className="primary-menu">
            <ul itemType="http://schema.org/SiteNavigationElement" itemScope={true} className="primary-menu__list">
